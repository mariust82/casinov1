! function(e) {
    ...
    var o, t, r, B = _.MutationObserver || _.WebKitMutationObserver || !1,
        ...
        l = function(e, o) {
            ...
            function i(e, o, t) {
                var r, i;
                return !(t || !k) || (0 === e.deltaMode ? (r = -e.deltaX * (x.mousescrollstep / 54) | 0, i = -e.deltaY * (x.mousescrollstep / 54) | 0) : 1 === e.deltaMode && (r = -e.deltaX * x.mousescrollstep * 50 / 80 | 0, i = -e.deltaY * x.mousescrollstep * 50 / 80 | 0), o && x.oneaxismousemode && 0 === r && i && (r = i, i = 0, t && (r < 0 ? b.getScrollLeft() >= b.page.maxw : b.getScrollLeft() <= 0) && (i = r, r = 0)), b.isrtlmode && (r = -r), l(r, i, t, !0) ? void(t && (k = !0)) : (k = !1, e.stopImmediatePropagation(), e.preventDefault()))
            }
            var b = this;
            ...
            this.getDocumentScrollOffset = function() {
                ...
                if ((S.isie11 || S.isie10) && (t["-ms-overflow-style"] = "none"), b.ishwscroll && (this.doc.css(S.transitionstyle, S.prefixstyle + "transform 0ms ease-out"), S.transitionend && b.bind(b.doc, S.transitionend, b.onScrollTransitionEnd, !1)), b.zindex = "auto", b.ispage || "auto" != x.zindex ? b.zindex = x.zindex : b.zindex = function() {
                    ...
                    if (!1 === x.autohidemode ? (b.autohidedom = !1, b.rail.css({
                        ...
                        b.scrollmom = new q(b), b.ontouchstart = function(e) {
                            if (b.locked) return !1;
                            if (e.pointerType && ("mouse" === e.pointerType || e.pointerType === e.MSPOINTER_TYPE_MOUSE)) return !1;
                            if (b.hasmoving = !1, b.scrollmom.timer && (b.triggerScrollEnd(), b.scrollmom.stop()), !b.railslocked) {
                                var o = b.getTarget(e);
                                if (o && /INPUT/i.test(o.nodeName) && /range/i.test(o.type)) return b.stopPropagation(e);
            ...
            if (this.onmousewheel = function(e) {
                ...
                if (b.ishwscroll && S.hastransition && x.usetransition && x.smoothscroll) {
                    ...
                    b.bzscroll = {};
                    var a = s ? 1 : .58;
                    b.bzscroll.x = new d(i, b.newscrollx, l, 0, 0, a, 1), b.bzscroll.y = new d(r, b.newscrolly, l, 0, 0, a, 1), X();
                    var c = function() {
                        if (b.scrollrunning) {
                    ...
                    var h = f.lastscrollx,
                        ...
                        m = function() {
                            ...
                            f.speedx && (h = Math.floor(f.lastscrollx - f.speedx * (1 - f.demulxy)), ((f.lastscrollx = h) < 0 || n < h) && (e = .1)), f.speedy && (p = Math.floor(f.lastscrolly - f.speedy * (1 - f.demulxy)), ((f.lastscrolly = p) < 0 || s < p) && (e = .1)), f.demulxy = Math.min(1, f.demulxy + e), f.nc.synched("domomentum2d", function() {
                                f.speedx && (f.nc.getScrollLeft(), f.chkx = h, f.nc.setScrollLeft(h)), f.speedy && (f.nc.getScrollTop(), f.chky = p, f.nc.setScrollTop(p)), f.timer || (f.nc.hideCursor(), f.doSnapy(h, p))
