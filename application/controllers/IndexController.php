...
class IndexController extends BaseController {
	public function service() {
        ...
        $this->response->setAttribute("new_casinos", $this->getCasinos(array( "promoted"=>1), CasinoSortCriteria::NEWEST, 5));
        $this->response->setAttribute("no_deposit_casinos", $this->getCasinos(array("promoted"=>1,"bonus_type"=>"No Deposit Bonus"), CasinoSortCriteria::NEWEST, 5));
