...
class AsyncReporter implements \Lucinda\MVC\STDERR\ErrorReporter
{
    ...
    public function __construct(\SimpleXMLElement $xml)
    {
        ...
        if (!$host || !$auth_key) {
            throw new \Lucinda\MVC\STDERR\Exception("AsyncReporter requires attributes: 'host' and 'auth_key'");
        }
    ...
    {
        if (in_array($request->getRoute()->getErrorType(), array(\Lucinda\MVC\STDERR\ErrorType::NONE, \Lucinda\MVC\STDERR\ErrorType::CLIENT))) {
            return;
        }
