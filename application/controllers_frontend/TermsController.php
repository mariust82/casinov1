<?php
class TermsController extends Lucinda\MVC\STDOUT\Controller {
    public function run() {
...
$this->response->attributes("page_info", array (
  ...
  'head_description' => 'CasinosLists.com Terms And Conditions | By using our site you agree to be bound by our terms of use. You are advised to read them carefully before browsing.',
