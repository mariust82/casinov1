<?php
class PrivacyController extends Lucinda\MVC\STDOUT\Controller {
    public function run() {
...
$this->response->attributes("page_info", array (
  ...
  'head_description' => 'CasinosLists.com Privacy Policy - Read our Privacy Policy page to learn more.',
