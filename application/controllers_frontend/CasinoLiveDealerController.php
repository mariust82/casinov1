...
$this->response->attributes("total_casinos", '858');
$this->response->attributes("total_casinos_left", 808);
$this->response->attributes("casinos", array (
  ...
  array (
    ...
    'new' => false,
    'score_class' => 'No score',
    'all_softwares' => 'Evolution Gaming, Ezugi, Vivo Gaming, Endorphina, Habanero, GameArt, Pragmatic Play, Kiron Interactive, Tom Horn Gaming, Evoplay, Spinomenal, Iron Dog Studio, Fugaso, Kalamba Games, Nolimit City, Betixon, Ganapati, Mascot Gaming, SlotVision, BF Games, Revolver Gaming, Reel NRG, OneTouch',
  ...
  array (
    ...
    array (
      ...
      'min_deposit' => '€20',
      'wagering' => '40xB',
      'games_allowed' => 'All (FS - AlmightySparta)',
      'code' => 'No code required',
      'type' => 'First Deposit Bonus',
      'bonus_type_Abbreviation' => NULL,
    ),
    ...
    'new' => true,
    'score_class' => 'No score',
    'all_softwares' => 'Evolution Gaming, Quickfire, Playson, Igrosoft, Play n GO, Endorphina, Habanero, Pragmatic Play, Spinomenal',
    'deposit_minimum' => '10',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'min_deposit' => '€/£10',
      'wagering' => '30x(D+B)',
      'games_allowed' => 'All (FS - Wild Torro)',
      'code' => 'No code required',
      'type' => 'First Deposit Bonus',
      'bonus_type_Abbreviation' => NULL,
    ),
    ...
    'new' => true,
    'score_class' => 'Poor',
    'all_softwares' => 'NYX Interactive, NextGen Gaming, IGT, Yggdrasil Gaming, Thunderkick, Evolution Gaming, Quickspin, Play n GO, Big Time Gaming, Eyecon, Bally, Blueprint Gaming, Barcrest Games, Pragmatic Play',
    'deposit_minimum' => '10',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    'id' => '2394',
    'name' => 'Lionel Bets Casino',
    'code' => 'lionel_bets_casino',
    'rating' => 6,
    'rating_votes' => NULL,
    'softwares' => 
    array (
    ...
    array (
      ...
      'min_deposit' => '€20',
      'wagering' => '35x(D+B)',
      'games_allowed' => 'Slots, Scratch Cards by Betsoft, Fugaso & GS',
      'code' => 'FIRST',
      'type' => 'First Deposit Bonus',
      'bonus_type_Abbreviation' => NULL,
    ),
    ...
    'new' => true,
    'score_class' => 'Good',
    'all_softwares' => 'Evolution Gaming, Ezugi, Vivo Gaming, ELK Studios, Big Time Gaming, Habanero, Booming Games, Pragmatic Play, PlayPearls, Evoplay, Iron Dog Studio, MrSlotty Games, LuckyStreak, Booongo, Kalamba Games, SA Gaming, Felix Gaming, Betixon, Xplosive, Ruby Play, Nucleus Gaming, Salsa Techonology',
    'deposit_minimum' => '20',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    ...
    'new' => true,
    'score_class' => 'No score',
    'all_softwares' => 'iSoftBet, Leander Games, Evolution Gaming, Quickspin, Push Gaming, Play n GO, ELK Studios, Big Time Gaming, Blueprint Gaming, Relax Gaming, EGT, Red Rake Gaming, Red Tiger Gaming, Kalamba Games, Fantasma Games, StakeLogic',
    'deposit_minimum' => '20',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
...
$this->response->attributes("page_info", array (
  'head_title' => 'Complete Live Roulette Casinos Directory 2021 | CasinosLists.com',
...
$this->response->attributes("widgets", array (
  'lower' => 
  array (
    0 => '<h2><span style="font-size:16px;"><strong>WHAT ARE LIVE DEALER ROULETTE CASINOS?</strong></span></h2>

<p><img class="lazy_loaded" data-src="https://www.casinoslists.com/upload/tms/roulette.jpg" style="display: block; margin-left: auto; margin-right: auto; width: 100%; height: 100%;" /><br />
If you&rsquo;ve always wanted to spice things up while playing this unique casino game online, live roulette gambling websites are the ones for you. That&rsquo;s because they collaborate with software providers to deliver high-quality streams and allow you to experience the land-based casino atmosphere without having to organize expensive trips to Vegas. So take a seat around a virtual table while a real live dealer runs the game for you, join other roulette fans and enjoy yourself! Take a quick peek at Evolution Gaming&rsquo;s Immersive Roulette presentation video below to see what&rsquo;s waiting for you:</p>

<p><iframe allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" frameborder="0" height="853" class="lazy_loaded" data-src="https://www.youtube.com/embed/WSG8mXOlB_A" width="100%"></iframe><br />
&nbsp;</p>

<h2><span style="font-size:16px;"><strong>THE ADVANTAGES OF PLAYING AT LIVE DEALER ONLINE ROULETTE CASINOS</strong></span></h2>

<p>There&rsquo;s a lot to be mentioned here, but we&rsquo;ll keep the section short by mentioning only some of the key benefits of live roulette casinos:</p>
...
<ul>
	...
	<li><strong>Accessibility</strong>: Live dealer roulette casinos are accessible from anywhere, provided that you have a stable internet connection and decent device to play on. These days, you can opt for either desktop or <a href="https://www.casinoslists.com/casinos/mobile">mobile casinos</a> without having to sacrifice game quality.</li>
</ul>

<h2><span style="font-size:16px;"><strong>LIVE ROULETTE CASINO TIPS</strong></span></h2>

<p>If you&rsquo;re having a difficult time choosing from our extensive directory of gambling websites, here are some tips that will help you make the searching process easier:</p>

<ul>
	<li><strong>Pick a Reputable Live Roulette Casino:</strong> As you can see, each casino on our list has a certain rating. This represents the evaluation of our players&rsquo; community and can tell you a great deal about the quality of that gambling website. Pay attention to this detail when choosing your next playground and don&rsquo;t forget that being verified by authorities of the gambling world is an important aspect as well.</li>
	<li><strong>Choose the Right Table for Your Budget:</strong> You can find live roulette tables for any pocket, from variants with really low bet limits to high roller ones. Once you&rsquo;ve established your budget for the gambling session, make sure to pick tables that are within your boundaries.</li>
...
',
    1 => '<div class="widget faq" itemscope itemtype="https://schema.org/FAQPage"><h2>FREQUENTLY ASKED QUESTIONS</h2><div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><div itemprop="name"><strong>Do live roulette casinos offer no deposit welcome bonuses?</strong></div><div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><div itemprop="text">Of course! As a matter of fact, you can use the Free bonus filter to see all the 173 live roulette casinos that will grant you a freebie upon registration, under the form of either free spins or free cash!</div></div></div><div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><div itemprop="name"><strong>Can I use any payment method to deposit and withdraw funds?</strong></div><div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><div itemprop="text">Well, it depends on the casino. Each site accepts a variety of payment options, which are displayed on its review page. Make sure to see if your banking method of choice is available for both deposits and withdrawals, as it will make your transactions much quicker in the future.</div></div></div><div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><div itemprop="name"><strong>Where can I find the best live dealer roulette casinos?</strong></div><div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><div itemprop="text"><p>To see which are the best live roulette gambling sites, simply sort the list by Top Rated. This will enable you to see which are your top choices, according to our real players&rsquo; community.</p></div></div></div></div>',
  ),
  'upper' => 
  array (
    0 => '<p>Welcome to CasinosLists&rsquo; Live Roulette Casinos directory, which counts as many as <span class="dyna-var" id="foo">858</span>&nbsp;brands. Take the time to browse, go through the review pages of each gambling site and pick whichever one meets your gambling needs!</p>

<p>&nbsp;</p>

<h2><span style="font-size:16px;"><strong>LIVE ROULETTE ONLINE CASINOS LIST</strong></span></h2>

<p>As mentioned earlier, right below you&rsquo;ll find a complete and detailed list of <span class="dyna-var" id="foo">858</span>&nbsp;live dealer roulette casinos which will allow you to enjoy your favorite table game. We provide you with all the information you need, from player rating to welcome package and software providers, so you&rsquo;ll easily be able to find what you&rsquo;re looking for. Don&rsquo;t forget about the filters and sorting tools either, as they&rsquo;re here to make your searching process easier and quicker. For example, use the <strong>country</strong> filter to only display the <span class="dyna-var" id="foo">47</span>&nbsp;gambling sites available for players from <span class="dyna-var" id="foo">United States.</span></p>
',
  ),
));
