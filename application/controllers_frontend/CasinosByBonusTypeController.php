...
$this->response->attributes("total_casinos", '301');
$this->response->attributes("total_casinos_left", 253);
$this->response->attributes("casinos", array (
  ...
  array (
    ...
    'new' => true,
    'score_class' => 'Good',
    'all_softwares' => 'Saucify, Nucleus Gaming',
    'deposit_minimum' => '30',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    'id' => '2368',
    'name' => 'NgageWin Casino',
    'code' => 'ngagewin_casino',
    'rating' => 6,
    'rating_votes' => NULL,
    'softwares' => 
    array (
    ...
    'new' => true,
    'score_class' => 'Good',
    'all_softwares' => 'NextGen Gaming, Oryx Gaming, iSoftBet, BetSoft, Wazdan, NetEnt, Thunderkick, Evolution Gaming, Quickspin, 1X2 Gaming, Ezugi, Playson, Endorphina, Big Time Gaming, Habanero, Pariplay, Relax Gaming, Booming Games, Pragmatic Play, BetConstruct, EGT, Gamomat, MrSlotty Games, Betgames TV, Red Tiger Gaming, Kalamba Games',
    'deposit_minimum' => '10',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    ...
    'new' => true,
    'score_class' => 'Good',
    'all_softwares' => 'Oryx Gaming, iSoftBet, BetSoft, Thunderkick, Evolution Gaming, 1X2 Gaming, Playson, Endorphina, BGaming, Big Time Gaming, Habanero, Pariplay, Pragmatic Play, BetConstruct, EGT, Evoplay, Gamomat, MrSlotty Games, Betgames TV, Red Tiger Gaming, Kalamba Games, FAZI',
    'deposit_minimum' => '10',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    ...
    'new' => true,
    'score_class' => 'Excellent',
    'all_softwares' => 'Oryx Gaming, iSoftBet, BetSoft, Wazdan, NetEnt, Thunderkick, Evolution Gaming, Quickspin, 1X2 Gaming, Ezugi, Playson, Endorphina, ELK Studios, Big Time Gaming, Habanero, Pariplay, Relax Gaming, Booming Games, Pragmatic Play, BetConstruct, EGT, Gamomat, MrSlotty Games, Betgames TV, Red Tiger Gaming, Kalamba Games',
    'deposit_minimum' => '10',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    'id' => '2302',
    'name' => 'VIP Club Player Casino',
    'code' => 'vip_club_player_casino',
    'rating' => 8,
    'rating_votes' => NULL,
    'softwares' => 
    array (
  ...
  array (
    'id' => '2278',
    'name' => 'LuckyZon Casino',
    'code' => 'luckyzon_casino',
    'rating' => 8,
    'rating_votes' => NULL,
    'softwares' => 
    array (
    ...
    array (
      ...
      'min_deposit' => '',
      'wagering' => '99xB',
      'games_allowed' => 'SpinJoy',
      'code' => 'LZ30CHIP',
      'type' => 'Free Spins',
      'bonus_type_Abbreviation' => NULL,
    ),
    'live_dealers' => NULL,
    'date_established' => '2020-08-17',
    'emails' => NULL,
    'phones' => NULL,
    'is_live_chat' => NULL,
    'licenses' => NULL,
    ...
    'new' => true,
    'score_class' => 'Excellent',
    'all_softwares' => 'Oryx Gaming, iSoftBet, BetSoft, Wazdan, NetEnt, Thunderkick, Evolution Gaming, Quickspin, 1X2 Gaming, Ezugi, Playson, Endorphina, ELK Studios, Big Time Gaming, Habanero, Pariplay, Relax Gaming, Pragmatic Play, BetConstruct, EGT, Gamomat, MrSlotty Games, Betgames TV, Red Tiger Gaming, Kalamba Games',
    'deposit_minimum' => '10',
    'welcome_package' => NULL,
    'casino_deposit_methods' => 
    array (
  ...
  array (
    'id' => '2268',
    'name' => 'Wilderino Casino',
    'code' => 'wilderino_casino',
    'rating' => 5,
    'rating_votes' => NULL,
    'softwares' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'min_deposit' => '',
      'wagering' => '99xB',
      'games_allowed' => ' Summer Bliss',
      'code' => 'CHIPY50WOW',
      'type' => 'Free Spins',
      'bonus_type_Abbreviation' => NULL,
    ),
    'live_dealers' => NULL,
    'date_established' => '2020-08-04',
    'emails' => NULL,
    'phones' => NULL,
    'is_live_chat' => NULL,
    'licenses' => NULL,
...
$this->response->attributes("page_info", array (
  ...
  'head_description' => ' Full List of No Deposit Casinos | Take on 301 Free Spins, Free Play & No Deposit Bonuses on Sign up allowing you to keep what you win with no deposit required!',
...
$this->response->attributes("widgets", array (
  'lower' => 
  array (
    0 => '<h2><span style="font-size:16px;"><strong>What Types of &ldquo;Free Bonuses&rdquo; Can You Claim?</strong></span></h2>

<p>No Deposit Casinos are numerous following the growth in popularity of free bonuses and will allow you to win real cash with no cost attached. Let&#39;s face it, &ldquo;no deposit&rdquo; bonuses basically scream &ldquo;Come get me!&rdquo; for both novice and experienced casino players. We divide no deposit offers into three main forms:&nbsp;</p>

<ul>
	<li><strong>No Deposit Bonus</strong> - The principle of the real money no deposit bonus is to make a small number of credits available to the player that will allow him to test various games of the casino. Afterward, he will be able to keep his winnings.</li>
	<li><strong>Free</strong> <strong>Spins</strong> - No deposit real cash free spins can be claimed just like other types of no deposit bonuses and can target new, existing or all players. They are usually available for a certain slot game or specific games, depending on your casino of choice. Funds won are withdrawable.</li>
	<li><strong>Free</strong> <strong>Play</strong> - This is a kind of bonus offered to players allowing them to enjoy a couple of minutes to a couple of hours of free play time on certain games such as slot machines, blackjack or roulette. Please note that unlike other offers, this type of bonus is not withdrawable, Meaning, your balance will be zeroed once the Free Play time is over.</li>
</ul>

<h2><span style="font-size:16px;"><strong>No Deposit Bonuses Restrictions</strong></span></h2>

<p>The offers presented above come with several conditions you need to be aware of before claiming them:&nbsp;</p>

<ul>
	<li><strong>Games</strong> <strong>accepted</strong> - Most free real cash bonuses are only available for a certain game or a category such as <a href="https://www.casinoslists.com/games/classic-slots">slots</a> or <a href="https://www.casinoslists.com/games/table-games">table games</a>. You should make sure you only play the games that are allowed, not following this condition may result in losing your winnings for breaking the bonus terms.</li>
	<li><strong>Wagering requirements (Playthrough)</strong> - If you intend to withdraw your real money winnings before completing the wagering requirements, the casino may require you to keep playing until you finish the wagering. Some bonuses may not require any wagering at all in order to make things easier for new players.&nbsp;</li>
	<li><strong>Availability</strong> - Part of no deposit bonuses are often available for a certain period of time, from a couple of days to a month or even a year for new registered players, so check out their accessibility and see for how much time they&rsquo;re up for grabs.</li>
	<li><strong>Card</strong> <strong>Registration</strong> - &nbsp;There are cases where online casinos only offer free spins on card registration. In such cases, your credit or debit card will not be charged by the gambling site, and providing your banking information is purely for security and verification purposes.</li>
</ul>

<h2><span style="font-size:16px;"><strong>How to Claim a No Deposit Bonus?</strong></span></h2>

<p>It is important to know how to use these no deposit bonuses in your advantage, that&rsquo;s why we put together a list of common ways to claim and redeem a free sign up bonus:</p>

<ul>
	<li>If the bonus has a code, players are required to insert it in the registration form when they sign up to the casino in question. Next, all they have to do is enter the relevant bonus code and click on the &ldquo;Redeem&rdquo; button.</li>
	<li>If the bonus doesn&#39;t have a bonus code, players should make sure they sign up using the link from CasinosLists.com, and the bonus will automatically appear after registration.</li>
	<li>Some online casinos have a dedicated section for &quot;Promotions&quot;, where users are able to claim the bonus by following the steps listed on the page.</li>
	<li>For any assistance, players can contact the casino&rsquo;s support team in order to help them in receiving the bonus. If for some reason, any information is not correct, they can contact us via our <a href="https://www.casinoslists.com/contact">Contact page</a> and we will help them in getting the bonus.</li>
</ul>
',
  ),
  'upper' => 
  array (
    0 => '<p>All players love getting rewarded with free spins and no deposit bonuses, and we at CasinosLists.com provide a total of 301 <a href="https://www.casinoslists.com/casinos">casinos</a> that give the players various prizes. From <a href="https://www.casinoslists.com/softwares/rtg">Real Time Gaming</a> to <a href="https://www.casinoslists.com/softwares/betsoft">BetSoft</a> or <a href="https://www.casinoslists.com/softwares/netent">NetEnt</a>, all of these offer free sign up coupons and bonuses. This way, you may try the games and casinos without actually betting real money at first. Keep in mind that with the country filter you may see the 104 casinos you may access from United States. Also, to see the <a href="https://www.casinoslists.com/casinos/best">best casinos</a> or the <a href="https://www.casinoslists.com/casinos/new">newest casinos</a>, check the &ldquo;Top Rated&rdquo; and &ldquo;Newest&rsquo; tabs.</p>
',
  ),
));
